...
export default function DefaultUserTableCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new DefaultUserTable(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "DefaultUserTableCreateForm")}
      {...rest}
    >
      <TextField
        label="Profile img"
